	...
	class Wbcom_Admin_Settings {
		...
		public function wbcom_enqueue_admin_scripts() {
			if ( ! wp_style_is( 'font-awesome', 'enqueued' ) ) {
				wp_enqueue_style( 'font-awesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', array( ), BPQUOTES_NAME_VERSION, false );
			}
			if ( ! wp_script_is( 'wbcom_admin_setting_js', 'enqueued' ) ) {
				...
				wp_register_script(
					...
					BPQUOTES_PLUGIN_URL . 'admin/wbcom/assets/js/wbcom-admin-setting' . $js_extension,
					array( 'jquery' ),
					BPQUOTES_NAME_VERSION,
					false
				);
				wp_localize_script(
					'wbcom_admin_setting_js',
			...
			if ( ! wp_style_is( 'wbcom-admin-setting-css', 'enqueued' ) ) {
				...
				wp_enqueue_style( 'wbcom-admin-setting-css', BPQUOTES_PLUGIN_URL . 'admin/wbcom/assets/css' . $rtl_css . '/wbcom-admin-setting' . $css_extension, array( ), BPQUOTES_NAME_VERSION, false );
			}
		}
		...
		public function wbcom_admin_additional_pages() {
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Our Plugins', 'buddypress-quotes' ),
				esc_html__( 'Our Plugins', 'buddypress-quotes' ),
				'manage_options',
				'wbcom-plugins-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Our Themes', 'buddypress-quotes' ),
				esc_html__( 'Our Themes', 'buddypress-quotes' ),
				'manage_options',
				'wbcom-themes-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Support', 'buddypress-quotes' ),
				esc_html__( 'Support', 'buddypress-quotes' ),
				'manage_options',
				'wbcom-support-page',
					...
					<ul>
						...
						<li class="wb_admin_nav_item <?php echo esc_attr( $plugin_active ); ?>">
							<a href="<?php echo esc_url( get_admin_url() ) . 'admin.php?page=wbcom-plugins-page'; ?>" id="wb_admin_nav_trigger_extensions">
								...
								<h4><?php esc_html_e( 'Themes & Extension', 'buddypress-quotes' ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $support_active ); ?>">
							<a href="<?php echo esc_url( get_admin_url() ) . 'admin.php?page=wbcom-support-page'; ?>" id="wb_admin_nav_trigger_support">
								...
								<h4><?php esc_html_e( 'Help & Support', 'buddypress-quotes' ); ?></h4>
							</a>
						</li>
