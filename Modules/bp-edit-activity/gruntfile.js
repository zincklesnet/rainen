module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        checktextdomain: {
            options: {
                text_domain: 'buddypress-edit-activity', // Change this to your text domain
                keywords: [
                    '__:1,2d',
                    '_e:1,2d',
                    '_x:1,2c,3d',
                ...
                files: [
                    {
                        ...
                        ext: '.css', // Extension for RTL files
        ...
        shell: {
            wpcli: {
                command: 'wp i18n make-pot . languages/buddypress-edit-activity.pot',
            }
        }
    });
