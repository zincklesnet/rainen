...
<div class="zf-form-group <?php if( isset($error["error"]) && $error["error"] == true ) echo 'zf-error'; ?> <?php if( isset($field["field_visibility"]) && $field["field_visibility"] == 'hidden' ) echo 'zf-hidden-field'; ?>" data-zombify-fieldgroup-path="<?php echo $field_input_path; ?>">
    ...
    ?>
    <textarea name="zombify<?php echo $field_input_name; ?>" data-zombify-name-index="<?php echo $name_index ?>" data-zombify-field-path="<?php echo $field_input_path; ?>" data-zombify-field-path="<?php echo $field_input_path; ?>" <?php echo $attributes; ?> <?php echo $placeholder; ?>><?php echo $field_value ?></textarea>
    <?php
