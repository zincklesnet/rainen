<div id="zombify-main-section" class="zombify-main-section zf-quiz zombify-personality-quiz zombify-screen">
    ...
    switch( $action ){
        case "create":
            ?><h2 class="zf-global-title"><?php printf( esc_html__("Create %s", "zombify"), $zf_config['zf_post_types']['personality']['name'] ); ?></h2><?php
            break;
        case "update":
            ?><h2 class="zf-global-title"><?php printf( esc_html__("Update %s", "zombify"), $zf_config['zf_post_types']['personality']['name'] ); ?></h2><?php
            break;
    }
    ?>
            ...
            <div id="zf-main" class="zf-main">
                ...
                <div class="zf-info-wrapper">
                    ...
                    <div class="zf-preface-excerpt-cont">
                        <?php
                            if( $zf_config['zf_post_types']['personality']['excerpt'] === 1 ) {
                                echo $this->renderField(['use_excerpt'], '', 0, $this->data, array(), '', array('showPlaceholder' => false, 'showLabel' => true));
                            }
                            if( $zf_config['zf_post_types']['personality']['preface'] === 1 ) {
                                echo $this->renderField(['use_preface'], '', 0, $this->data, array(), '', array('showPlaceholder' => false, 'showLabel' => true));
                            }
                        ?>
                    </div>
                    <div class="zf-excerpt <?php if( ( isset( $this->data["use_excerpt"] ) && $this->data["use_excerpt"] ) || $zf_config['zf_post_types']['personality']['excerpt'] === 0 ) echo 'zf-open'; ?>">
                    ...
                    <div class="zf-preface <?php if( ( isset( $this->data["use_preface"] ) && $this->data["use_preface"] ) || $zf_config['zf_post_types']['personality']['preface'] === 0 ) echo 'zf-open'; ?>">
                ...
                <div class="zf-item-wrapper">
                    <div class="zombify_group">
                        <div class="zf-inner-wrapper zf-personality-inner-wrapper">
