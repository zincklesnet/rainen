...
<div class="zf-inner-wrapper">
	...
	<div class="zf-body zf-numeric">
		...
		echo $this->renderField(
			...
			$name_index,
			$data,
			array( "placeholder" => esc_attr( __( "https://example.com", "zombify" ) ), "rel" => "nofollow" ),
			'',
		...
		echo $this->renderField(
			array( 'list', 'resource_url' ),
			$field_name_prefix,
			$name_index,
			$data,
			array( "placeholder" => esc_attr( __( "https://example.com", "zombify" ) ) ),
			'',
			array( 'showPlaceholder' => true, 'showLabel' => true )
		);
		?>
