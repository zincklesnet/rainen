<div id="zombify-main-section" class="zombify-main-section zf-list zombify-screen" data-post_type="countdown">
    <?php
    ...
    switch( $action ){
        case "create":
            ?><h2 class="zf-global-title"><?php printf( esc_html__("Create %s", "zombify"), $zf_config['zf_post_types']['countdown']['name'] ); ?></h2><?php
            break;
        case "update":
            ?><h2 class="zf-global-title"><?php printf( esc_html__("Update %s", "zombify"), $zf_config['zf_post_types']['countdown']['name'] ); ?></h2><?php
            break;
    }
            ...
            <div id="zf-main" class="zf-main">
                ...
                <div class="zf-info-wrapper">
                    ...
                    <div class="zf-preface-excerpt-cont">
                        <?php
                            if( $zf_config['zf_post_types']['countdown']['excerpt'] === 1 ) {
                                echo $this->renderField(['use_excerpt'], '', 0, $this->data, array(), '', array('showPlaceholder' => false, 'showLabel' => true));
                            }
                            if( $zf_config['zf_post_types']['countdown']['preface'] === 1 ) {
                                echo $this->renderField(['use_preface'], '', 0, $this->data, array(), '', array('showPlaceholder' => false, 'showLabel' => true));
                            }
                        ?>
                    </div>
                    <div class="zf-excerpt <?php if( ( isset( $this->data["use_excerpt"] ) && $this->data["use_excerpt"] ) || $zf_config['zf_post_types']['countdown']['excerpt'] === 0 ) echo 'zf-open'; ?>">
                    ...
                    <div class="zf-preface <?php if( ( isset( $this->data["use_preface"] ) && $this->data["use_preface"] ) || $zf_config['zf_post_types']['countdown']['preface'] === 0 ) echo 'zf-open'; ?>">
                ...
                <div class="zf-list-container zf-item-wrapper" data-reverse="1">
                    ...
                    <?php echo $this->renderAddGroupButton( ['list'], esc_html__( 'Add Item', 'zombify' ), '', ['reverse_order' => 1]); ?>
