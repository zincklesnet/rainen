    ...
    <div class="zf-body">
        <div class="zf-row">
            <div class="zf-col-lg-1">
                <?php echo $this->renderField($this->fieldPath(['results','image'], $aliased_group_path, $path_prefix), $field_name_prefix, $name_index, $data); ?>
            </div>
            <div class="zf-col-lg-3">
                ...
                <?php echo $this->renderField($this->fieldPath(['results','original_source'], $aliased_group_path, $path_prefix), $field_name_prefix, $name_index, $data, array(), '', array('showPlaceholder'=>true, 'showLabel'=>false), $path_prefix); ?>
                <?php echo $this->renderField($this->fieldPath(['results','image_credit'], $aliased_group_path, $path_prefix), $field_name_prefix, $name_index, $data, array("placeholder"=> esc_attr( __("http://example.com", "zombify"))), '', array('showPlaceholder'=>false, 'showLabel'=>true), $path_prefix); ?>
                <?php echo $this->renderField($this->fieldPath(['results','image_credit_text'], $aliased_group_path, $path_prefix), $field_name_prefix, $name_index, $data, array(), '', array('showPlaceholder'=>false, 'showLabel'=>true), $path_prefix); ?>
