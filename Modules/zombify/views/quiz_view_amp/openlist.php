			...
			foreach ( $data["list"] as $list ) {
				...
				<li class="zfSetItem">
					...
					<?php if ( $list["description"] ) { ?>
						<div class="zf-list_description"><?php echo wp_kses_post( html_entity_decode( $list["description"] ) ); ?></div>
					<?php } ?>

					<?php if ( ! empty( $list["resource_url"] ) ) { ?>
                        <br/>
                        <div class="zf-list_description"><?php esc_html_e( "Resource URL:", "zombify" ); ?>
                            <a href="<?php echo esc_url( $list["resource_url"] ); ?>" target="_blank"> <?php echo esc_url( $list["resource_url"] ); ?></a>
                        </div>
                        <br/>
                    <?php } ?>
