...
jQuery(document).ready(
	function () {
		...
		jQuery(document).on('click', '#wbbprof_to_reset', function (e) {
			e.preventDefault();
			var data = {
				'action': 'wbbprof_reset_keywords',
				'ajax_nonce': bp_profanity.ajax_nonce
			};
			jQuery.post(bp_profanity.ajax_url, data, function (response) {
