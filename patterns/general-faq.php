...
/**
 * Title: FAQ - Editorial
 * Slug: reign/general-faq
 * Categories: reign-pricing-faq, text
 * Viewport Width: 1440
 */
...
<div class="wp-block-group alignfull has-base-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)">
  ...
  <div class="wp-block-columns alignwide are-vertically-aligned-top">
    ...
    <!-- wp:column {"verticalAlignment":"top","width":"60%","className":"reign-faq-stack"} -->
    <div class="wp-block-column is-vertically-aligned-top reign-faq-stack" style="flex-basis:60%">
