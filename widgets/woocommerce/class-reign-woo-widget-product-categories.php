...
class Reign_Woo_Widget_Product_Categories extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'per_row' ) ); ?>"><?php esc_html_e( 'Number of categories per row:', 'reign' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php esc_html_e( 'Number of categories:', 'reign' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'selected_categories' ) ); ?>"><?php esc_html_e( 'Selected Categories: (comma-separated IDs)', 'reign' ); ?></label>
