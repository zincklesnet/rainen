...
class BP_Reign_Profile_Completion_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Show logged-in user\'s profile completion progress.', 'reign' ),
		);
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $profile_groups_selected ) && empty( $profile_phototype_selected ) ) {
			...
			// Default to available photo types.
					...
					<div class="wb-bp-user-avatar-wrap">
						<div class="wb-bp-user-avatar">
							...
							if ( ( $current_user instanceof WP_User ) ) {
								...
								?>
								<?php
								echo get_avatar( $current_user->user_email, 200, '', '', array( 'loading' => 'lazy' ) );
								echo '</a>';
							}
							?>
						</div>
