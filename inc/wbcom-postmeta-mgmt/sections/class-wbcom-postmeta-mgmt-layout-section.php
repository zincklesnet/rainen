										...
										<div class="wbcom-metabox-field">
											...
											if ( '' === $sub_header_banner_image ) :
												...
												<div class="image" >
													...
													<div class="actions">
														<a href="#" class="delete" title="<?php echo esc_attr__( 'Delete image', 'reign' ); ?>"><i class="dashicons dashicons-no"></i></a>
													</div>
												</div>
											</div>
											...
											<div class="clearfix reign_subheader_banner_image_description">
												<p class="add_subheader_banner_image hide-if-no-js">
													<a class="components-button is-primary button button-primary button-large" href="#"><?php esc_html_e( 'Add Subheader Banner Image', 'reign' ); ?></a>
												</p>
											</div>
										</div>
									</div>
