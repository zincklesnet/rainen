<?php
/**
 * Reign\Customizer_Framework\Controls\Background
 *
		...
		<fieldset>
			...
			<div class="buddyx-background-controls" data-setting="<?php echo esc_attr( $this->setting ? $this->setting->id : '' ); ?>">
				<label class="buddyx-bg-row">
					<span><?php esc_html_e( 'Color', 'reign' ); ?></span>
					<input class="buddyx-bg-color" type="text" />
				</label>
				<label class="buddyx-bg-row">
					<span><?php esc_html_e( 'Image URL', 'reign' ); ?></span>
					<input class="buddyx-bg-image" type="url" placeholder="https://…" />
					<button type="button" class="button buddyx-bg-image-pick"><?php esc_html_e( 'Select Image', 'reign' ); ?></button>
				</label>
				<label class="buddyx-bg-row">
					<span><?php esc_html_e( 'Repeat', 'reign' ); ?></span>
				...
				<label class="buddyx-bg-row">
					<span><?php esc_html_e( 'Position', 'reign' ); ?></span>
				...
				<label class="buddyx-bg-row">
					<span><?php esc_html_e( 'Size', 'reign' ); ?></span>
				...
				<label class="buddyx-bg-row">
					<span><?php esc_html_e( 'Attachment', 'reign' ); ?></span>
