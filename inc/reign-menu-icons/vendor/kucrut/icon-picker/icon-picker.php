...
final class Icon_Picker {
	...
	protected function __construct( $args = array() ) {
		...
		$reign_menu_icons = reign_menu_icons();

		$defaults = array(
			'dir' => $reign_menu_icons->public_data['dir'] . 'vendor/kucrut/icon-picker/',
			'url' => $reign_menu_icons->public_data['url'] . 'vendor/kucrut/icon-picker/',
		);
