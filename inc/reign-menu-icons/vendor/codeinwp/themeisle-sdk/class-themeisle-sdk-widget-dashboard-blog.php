<?php
/**
 * The blog dashboard model class for Reign SDK
 *
 * @package     ReignSDK
 * @subpackage  Widgets
...
if ( ! class_exists( 'Reign_SDK_Widget_Dashboard_Blog' ) ) :
	/**
	 * Blog dashboard widget model for Reign SDK.
	 */
	class Reign_SDK_Widget_Dashboard_Blog extends Reign_SDK_Widget {
		...
		/**
		 * Reign_SDK_Widget_Dashboard_Blog constructor.
		 *
		 * @param Reign_ct $product_object The product object.
		 */
		...
		function setup_vars() {
			...
			$this->feeds          = apply_filters(
				'themeisle_sdk_dashboard_widget_feeds', array(
					'https://reigntheme.com/blog/feed',
				)
			);
		}
