 ...
 */
if ( ! class_exists( 'Reign_SDK_Licenser' ) ) :
	/**
	 * Class Reign_SDK_Licenser
	 *
	...
	class Reign_SDK_Licenser {
		...
		/**
		 * @var Reign_SDK_Product $product The Reign Product.
		 */
		private $product;
		/**
		...
		/**
		 * Reign_SDK_Licenser constructor.
		 *
		 * @param Reign_SDK_Product $product The product object.
		 */
