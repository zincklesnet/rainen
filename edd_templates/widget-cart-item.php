...
<li class="edd-cart-item">
	...
	<a href="{remove_url}" data-nonce="<?php echo esc_attr( wp_create_nonce( 'edd-remove-cart-widget-item' ) ); ?>" data-cart-item="{cart_item_id}" data-download-id="{item_id}" data-action="edd_remove_from_cart" class="edd-remove-from-cart"><i class="fa fa-times"></i><?php // _e( 'remove', 'reign' ); ?></a>
</li>
