 ...
 * @subpackage Wbcom_Essential/plugins/elementor/templates/sources
 */
abstract class WBcom_Essential_elementor_Templates_Source_Base {
	...
	public function templates_key() {
		return 'wbcom_essential_elementor_templates_' . $this->get_slug();
	}
	...
	public function categories_key() {
		return 'wbcom_essential_elementor_categories_' . $this->get_slug();
	}
	 ...
	 * @since  1.4.7
	 *
	 * @param array $value Template Cache Value.
	 */
	 ...
	 * @since  1.4.7
	 *
	 * @param array $value Categories cache value.
	 */
	 ...
	 * @access protected
	 *
	 * @param string $content Elememnts content.
	 */
