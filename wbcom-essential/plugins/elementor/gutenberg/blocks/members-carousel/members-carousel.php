<?php
/**
 * Members Carousel Block Registration.
 *
...
/**
 * Enqueue Swiper assets for Members Carousel block on frontend.
 */
function wbcom_essential_members_carousel_enqueue_assets() {
...
add_action( 'wp_enqueue_scripts', 'wbcom_essential_members_carousel_enqueue_assets' );

/**
 * Enqueue Swiper assets for Members Carousel block in editor.
 */
function wbcom_essential_members_carousel_enqueue_editor_assets() {
...
add_action( 'enqueue_block_editor_assets', 'wbcom_essential_members_carousel_enqueue_editor_assets' );
